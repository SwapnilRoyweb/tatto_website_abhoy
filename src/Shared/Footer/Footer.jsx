...
const Footer = () => {
    return (
        <footer className="footer mx-auto w-11/12 px-8 py-3 rounded-xl bg-gradient-to-r from-black to-slate-800 text-neutral-content flex flex-row items-center justify-around my-8">
