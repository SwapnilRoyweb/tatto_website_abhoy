        ...
        <div className='bg-gradient-to-r from-black to-slate-600 min-h-screen w-full flex flex-col justify-center'>
            ...
            <div className='flex flex-col items-center justify-center w-full md:flex-row flex-wrap gap-10 my-10'>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    ...
                    <figure><Tilt><img src={img1} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img2} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img3} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img4} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img5} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img6} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img7} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img8} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img9} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img10} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img11} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img12} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img13} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img14} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img15} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img16} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img17} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img18} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img19} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img20} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img21} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img22} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img23} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img24} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
                <div className="rounded-2xl w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                    <div className="card-body text-white flex flex-row justify-between">
                    ...
                    <figure><Tilt><img src={img25} alt="Shoes" className='w-full h-72 rounded-2xl'/></Tilt></figure>
                </div>
