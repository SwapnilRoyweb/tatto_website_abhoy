    ...
    return (
        <div className='bg-gradient-to-r from-black to-slate-600 min-h-screen w-full flex flex-col justify-center'>
            ...
            <div className='flex flex-col items-center justify-center w-full md:flex-row flex-wrap gap-5 my-10'>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                ...
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    ...
                    <figure><img src={img4} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img5} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img6} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img7} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img8} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img9} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img10} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img11} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img12} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img13} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img14} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img15} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img16} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img17} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img18} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img19} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img20} alt="Shoes" className='w-full h-72'/></figure>
                </div>
                <div className="card w-96 bg-gradient-to-l from-blue-500 to-slate-800 shadow-xl">
                    <div className="card-body text-white">
                    ...
                    <figure><img src={img21} alt="Shoes" className='w-full h-72'/></figure>
                </div>
